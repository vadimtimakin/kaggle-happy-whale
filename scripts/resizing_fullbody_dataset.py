...
path = "/home/toefl/K/dolphin/fullbody/train"
new_path = "/home/toefl/K/dolphin/fullbody_resized"

resize = SmartResize(256, 96, fillcolor=255)
...
for file in tqdm(os.listdir(path)):
    ...
    img = resize(img)
    cv2.imwrite(os.path.join(new_path, file), img)